...
dilaInterv = np.linspace(0.6 * dilaMin, 0.7 * dilaMax, 20)
...
plt.savefig('./experiments/imgdump/bottleneck_{}_{}_no_emb.pdf'.format(dataset,metric),format='pdf')
plt.savefig('./experiments/imgdump/bottleneck_{}_{}_no_emb.eps'.format(dataset,metric),format='eps')
plt.show()